...
hl.bind("SUPER + CTRL + ALT + G", hl.dsp.exec_cmd("app2unit -- gamescope-steam.desktop"))
hl.bind("SUPER + M", hl.dsp.exec_cmd("launch-or-focus 'Proton Mail' app2unit -- proton-mail.desktop"))
hl.bind("SUPER + N", hl.dsp.exec_cmd("app2unit -- nvim.desktop"))
...
hl.bind("SUPER + CTRL + COMMA", hl.dsp.exec_cmd(ipc .. "notification-invoke-latest"))
hl.bind("SUPER + CTRL + SHIFT + COMMA", hl.dsp.exec_cmd(ipc .. "notification-dnd-toggle"))
